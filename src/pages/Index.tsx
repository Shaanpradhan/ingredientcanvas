          ...
          {currentStep === "flavor" && (
            ...
            >
              <div className="text-center mb-8 mt-4">
                ...
                <motion.h1 
                  className="text-4xl font-semibold mb-3 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-500"
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
          ...
          {currentStep === "cuisine" && (
            ...
            >
              <div className="text-center mb-8 mt-4">
                ...
                <motion.h1 
                  className="text-4xl font-semibold mb-3 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400"
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2 }}
                >
          ...
          {currentStep === "ingredients" && (
            ...
            >
              <div className="text-center mb-8 mt-4">
                ...
                <motion.h1 
                  className="text-4xl font-semibold mb-3 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-orange-500"
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2 }}
                >
